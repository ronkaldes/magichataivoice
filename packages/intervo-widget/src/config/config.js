const API_CONFIG = {
  production:
    ...
    (typeof process !== "undefined" && process.env?.VITE_API_URL_PRODUCTION), // Production API URL from env
  development:
    import.meta.env?.VITE_API_URL_DEVELOPMENT ||
    (typeof process !== "undefined" && process.env?.VITE_API_URL_DEVELOPMENT), // Development API URL from env
};
